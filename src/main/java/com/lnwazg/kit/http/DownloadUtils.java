...
public class DownloadUtils
{
    ...
    {
        System.out.println(DownloadUtils.urlToStr("http://www.baidu.com"));
    }
    ...
    {
        return urlToStr(url, CharEncoding.UTF_8);
    }
     ...
     * @see [类、类#方法、类#成员]
     */
    public static String urlToStr(String urlStr, String encoding)
    {
        String result = "";
        try
        {
